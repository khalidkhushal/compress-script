...
def compress_video(args):
    ...
    ffmpeg_command = [
        ...
        # "-c:a", "aac",
        # "-q:a", "2",
        "-c:v", "h264_nvenc",  # Changed from libx264 to h264_nvenc for NVIDIA GPU encoding
        "-preset", "p1",       # Changed preset to p1 (NVENC specific preset)
        "-tune", "hq",         # Added tune parameter for higher quality
        "-c:a", "aac",
        "-q:a", "2",
        output_path
    ]
